...
public class SurveyModeratorService {
    ...
    private QuestionModel toEntity(SurveyModel survey, NewQuestionDto dto) {
        ...
        if (dto instanceof NewSubQuestionDto mcq) {
            ...
            savedQuestion.setImageUrl(Base64.getDecoder().decode(iq.getImageUrl()));
        }

        savedQuestion.setCorrectAnswer(toEntity(question, dto.getCorrectAnswer()));
    ...
    public void moveToArchive(Long id) {
        surveyRepository.moveToArchive(id);
    }
}
